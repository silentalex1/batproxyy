  ...
  if(url.pathname==='/proxy' || url.pathname.startsWith('/proxy/')){
    ...
    try{
      ...
      if(text!==null && ct.includes('html')){
        ...
        const inject=`<script>(function(){window.__bpBase=${JSON.stringify(base)};var PASSES=['proxy','api/auth','api/admin','api/suggestions','api/my-games','api/ai','api/status','api/changelogs','api/sites','api/check-blacklist','api/user/settings','wisp','uv','epoxy','baremux','site'];function p(u){try{if(!u||typeof u!=='string')return u;if(u.charAt(0)==='#'||u.indexOf('data:')===0||u.indexOf('blob:')===0||u.indexOf('javascript:')===0||u.indexOf('mailto:')===0)return u;if(u.indexOf('about:')===0)return u;if(u.indexOf('/proxy?url=')===0)return u;var a=new URL(u,window.__bpBase||document.baseURI);for(var i=0;i<PASSES.length;i++){if(a.pathname==='/' + PASSES[i]||a.pathname.indexOf('/' + PASSES[i]+'/')===0)return a.pathname+a.search+a.hash;}var b=new URL(window.__bpBase||document.baseURI);if(a.origin===window.location.origin)return '/proxy?url='+encodeURIComponent(b.protocol+'//'+b.host+a.pathname+a.search+a.hash);return '/proxy?url='+encodeURIComponent(a.href);}catch(e){return u;}}function stayIn(e){try{var a=e.target&&e.target.closest?e.target.closest('a[href]'):null;if(!a)return;var t=a.target||'';if(t==='_blank'||t==='_new'){e.preventDefault();e.stopPropagation();a.target='_self';a.href=p(a.href);return;}}catch(x){}}document.addEventListener('click',stayIn,true);document.addEventListener('auxclick',stayIn,true);setInterval(function(){try{var as=document.querySelectorAll('a[target="_blank"],a[target="_new"]');for(var i=0;i<as.length;i++){as[i].target='_self';as[i].href=p(as[i].href);}}catch(e){}},1200);var ow=window.open;window.open=function(u,f,feats){try{if(typeof u==='string'){return null;}}catch(e){}return ow(u,f,feats);};var of=window.fetch;window.fetch=function(i,n){try{var u=typeof i==='string'?i:(i&&i.url?i.url:null);if(!u)return of(i,n);if(u==='about:blank'||u==='about:srcdoc'||u.indexOf('about:blank')===0||u.indexOf('about:srcdoc')===0)return Promise.resolve(new Response('',{status:200,headers:{'Content-Type':'text/html'}}));if(u.indexOf('sentry.io')>-1||u.indexOf('cdn-cgi')>-1||u.indexOf('/_/_/')>-1||u.indexOf('ingest.sentry.io')>-1)return Promise.resolve(new Response('',{status:200,headers:{'Content-Type':'text/plain'}}));if(typeof i==='string')return of(p(i),n);if(i&&typeof Request!=='undefined'&&i instanceof Request)return of(new Request(p(i.url),i),n);if(i&&i.url)return of(new Request(p(i.url),i),n);}catch(e){}return of(i,n);};var oo=XMLHttpRequest.prototype.open;XMLHttpRequest.prototype.open=function(){var a=[].slice.call(arguments);if(typeof a[1]==='string'){if(a[1].indexOf('sentry.io')>-1||a[1].indexOf('cdn-cgi')>-1||a[1].indexOf('/_/_/')>-1||a[1].indexOf('ingest.')>-1){a[1]='data:text/plain,';}else a[1]=p(a[1]);}return oo.apply(this,a);};var osa=Element.prototype.setAttribute;Element.prototype.setAttribute=function(n,v){try{if(typeof v==='string'&&(n==='src'||n==='href'||n==='action')&&v.indexOf('data:')!==0&&v.indexOf('blob:')!==0&&v.indexOf('javascript:')!==0&&v.indexOf('about:')!==0&&v.charAt(0)!=='#')v=p(v);}catch(e){}return osa.call(this,n,v);};var ael=EventTarget.prototype.addEventListener;EventTarget.prototype.addEventListener=function(t,fn,opts){try{if(t==='unload'||t==='beforeunload'||t==='pagehide')return;}catch(e){}return ael.call(this,t,fn,opts);};window.addEventListener('unhandledrejection',function(e){e.preventDefault();},{capture:true});window.addEventListener('error',function(e){if(e&&e.message&&(e.message.indexOf('Failed to fetch')>-1||e.message.indexOf('ERR_NAME_NOT_RESOLVED')>-1||e.message.indexOf('ERR_FAILED')>-1||e.message.indexOf('net::')>-1||e.message.indexOf('WebSocket')>-1||e.message.indexOf('CORS')>-1||e.message.indexOf('AngularJS')>-1||e.message.indexOf('ApolloClient')>-1||e.message.indexOf('PurchaseDialog')>-1||e.message.indexOf('Sentry')>-1||e.message.indexOf('RealTime')>-1||e.message.indexOf('SignalR')>-1||e.message.indexOf('cdn-cgi')>-1||e.message.indexOf('sentry')>-1||e.message.indexOf('OW is not defined')))e.preventDefault();},{capture:true});(function(){var _w=console.warn,_e=console.error;console.warn=function(){var m=String(arguments[0]||'');if(/AngularJS|ApolloClient|PurchaseDialog|RealTime|SignalR|Sentry|cdn-cgi/i.test(m))return;return _w.apply(console,arguments);};console.error=function(){var m=String(arguments[0]||'');if(/AngularJS|ApolloClient|PurchaseDialog|RealTime|SignalR|Sentry|cdn-cgi|Failed to load|ERR_NAME_NOT_RESOLVED|ERR_FAILED|net::/i.test(m))return;return _e.apply(console,arguments);};})();(function(){var OWS=window.WebSocket;if(!OWS)return;window.WebSocket=function(u,pt){try{if(typeof u==='string'&&(u.indexOf('realtime.roblox.com')>-1||u.indexOf('sentry.io')>-1||u.indexOf('signalr')>-1)){var m=new EventTarget();setTimeout(function(){m.dispatchEvent(new CloseEvent('close'));if(m.onclose)m.onclose({});},50);m.send=function(){};m.close=function(){};m.readyState=3;return m;}}catch(x){}return new OWS(u,pt);};window.WebSocket.prototype=OWS.prototype;})();})();<\/script>`;
